...
- **複数の I2C デバイス**は、スレーブアドレスが互いに異なれば同じ I2C バスに並列接続して同時に使えます（Grove I2C ハブを使うと配線が楽です）。同じアドレスのデバイスを複数使いたい場合は、I2C マルチプレクサ **TCA9548A**（8チャンネル切替、アドレス 0x70〜0x77）を使う方法があります（サンプル: [tca9548a](tca9548a)、ドライバ: [@chirimen/tca9548a](https://github.com/chirimen-oh/chirimen-drivers/tree/master/packages/tca9548a)）。
